...
function App() {
    ...
    useEffect(() => {
        ...
        // Occasionally, the template's preloader doesn't hide properly in React.
        ...
        if (loader) {
            const hideLoader = () => {
                ...
                setTimeout(() => {
                    ...
                    // Re-trigger WOW animation or other scripts if needed
                    ...
                    <div className="container">
                        <div className="row g-4 gx-5 align-items-center justify-content-center text-center">
                            <div className="col-lg-10" style={{ marginTop: '70px' }}>
                                ...
                                <h2 className="wow fadeInUp font-weight-bold" data-wow-delay=".4s" style={{ marginTop: '10px', marginBottom: '20px', color: '#a3ff00', textShadow: '0 0 15px rgba(163, 255, 0, 0.6), 0 0 30px rgba(163, 255, 0, 0.4)', fontSize: '36px' }}>
                    ...
                    <div className="container">
                        <div className="row align-items-center gx-5">
                            ...
                            <div className="col-lg-6">
                                <h2 className="wow fadeInUp" data-wow-delay=".2s" style={{ lineHeight: '1.2' }}>Apa Itu Lomba Cipta Game Nasional Clevio?</h2>
                                {/*  Aksen lime green  */}
                    ...
                    <div className="lcgn-testimonial-marquee-container">
                        <div className="lcgn-testimonial-track">
                            {[...testimonialsData, ...testimonialsData].map((testi, index) => (
                                <div key={index} className="lcgn-testimonial-card">
                                    ...
                                    <div className="lcgn-price-card">
                                        <div className="lcgn-price-card-header">
                                            ...
                                            <div className="lcgn-price-amount">
                                                <span className="amount">Rp 100K</span>
                                ...
                                <div className="mt-5 p-4 p-md-5 rounded-4 wow fadeInUp" style={{ 
                                    ...
                                    <div className="row align-items-center">
                                        <div className="col-lg-1 text-center text-lg-start mb-3 mb-lg-0">
                                            <div className="p-3 rounded-circle d-flex align-items-center justify-content-center" style={{ width: '70px', height: '70px', backgroundColor: 'rgba(163, 255, 0, 0.1)' }}>
                                                <i className="fa fa-tags fs-3" style={{ color: '#a3ff00' }}></i>
                                            </div>
                                        </div>
                                        <div className="col-lg-11">
                                            <h4 className="text-white mb-3 fw-bold" style={{ letterSpacing: '2px' }}>PENAWARAN KHUSUS PENDAFTARAN KOLEKTIF SEKOLAH</h4>
                                            <div className="row g-4">
                                                <div className="col-md-4">
                                                    <div className="p-3 rounded-3 h-100" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                                        <h5 className="id-color mb-2">Pendaftaran 3 Tim</h5>
                                                        <p className="mb-0 fs-14 op-8">Gratis biaya pendaftaran untuk 1 orang kategori Guru. Satu tim Guru hanya perlu membayar <strong>Rp50.000</strong>.</p>
                                                    </div>
                                                </div>
                                                <div className="col-md-4">
                                                    <div className="p-3 rounded-3 h-100" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                                        <h5 className="id-color mb-2">Pendaftaran 5 Tim</h5>
                                                        <p className="mb-0 fs-14 op-8">Nikmati potongan <strong>Rp50.000/tim Siswa</strong> serta Gratis biaya pendaftaran untuk <strong>1 Tim Guru</strong> (2 orang).</p>
                                                    </div>
                                                </div>
                                                <div className="col-md-4">
                                                    <div className="p-3 rounded-3 h-100" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                                        <h5 className="id-color mb-2">Pendaftaran {'>'}5 Tim</h5>
                                                        <p className="mb-0 fs-14 op-8">Potongan <strong>Rp50.000/tim Siswa</strong>, Gratis 1 Tim Guru, serta biaya khusus hanya <strong>Rp50.000/tim</strong> untuk tim Guru setiap berikutnya.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
