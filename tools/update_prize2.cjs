...
// 1. Extract the broken Prizepool section
const { sectionStart } = extractTag('id="section-prizepool"');

// 2. Define the fixed content using absolute div instead of img.jarallax-img
const fixedPrizepool = `                {/* section-prizepool */}
...
// Reconstruct
const finalContent = content.substring(0, sectionStart) + fixedPrizepool + content.substring(sectionStart);
fs.writeFileSync(file, finalContent, 'utf8');
console.log('Prizepool background fixed!');
